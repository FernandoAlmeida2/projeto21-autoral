    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.sent();
                    return [4 /*yield*/, prisma.translation.createMany({
                            data: [
                                {
                                    cardId: 1,
                                    translation: "to love",
                                ...
                                {
                                    cardId: 45,
                                    translation: "noun suffix for specialists in some activity such as musician or revolutionary",
                                },
                                {
                                    cardId: 45,
                                ...
                                {
                                    cardId: 52,
                                    translation: "colloquial word for yuan (or other unit of currency such as Hong Kong or US dollar etc)",
                                },
                                {
                                    cardId: 52,
                                ...
                                {
                                    cardId: 58,
                                    translation: "(placed between two numbers to indicate a smaller quantity followed by a larger one)",
                                },
                                {
                                    cardId: 58,
                                ...
                                {
                                    cardId: 71,
                                    translation: "particle indicating that a previously asked question is to be applied to the preceding word (What about ...?,And ...?)",
                                },
                                {
                                    cardId: 71,
                                ...
                                {
                                    cardId: 71,
                                    translation: "to emphasize the preceding words and allow the listener time to take them on board (ok?)",
                                },
                                {
                                    cardId: 71,
                                ...
                                {
                                    cardId: 71,
                                    translation: "(at the end of a declarative sentence) particle indicating continuation of a state or action",
                                },
                                {
                                    cardId: 71,
                                ...
                                {
                                    cardId: 72,
                                    translation: "(usually used in the negative) to have the possibility of",
                                },
                                {
                                    cardId: 73,
                                ...
                                {
                                    cardId: 83,
                                    translation: "(when used either before or after a verb) to go in order to do sth",
                                },
                                {
                                    cardId: 83,
                                ...
                                {
                                    cardId: 83,
                                    translation: "(after a verb of motion indicates movement away from the speaker)",
                                },
                                {
                                    cardId: 83,
                                    translation: "(used after certain verbs to indicate detachment or separation)",
                                },
                                {
                                    cardId: 83,
                                ...
                                {
                                    cardId: 105,
                                    translation: "(used for either sex when the sex is unknown or unimportant)",
                                },
                                {
                                    cardId: 105,
                                ...
                                {
                                    cardId: 124,
                                    translation: "measure word indicating a small amount or small number (greater than 1)",
                                },
                                {
                                    cardId: 125,
                                ...
                                {
                                    cardId: 147,
                                    translation: "courtesy or style name traditionally given to males aged 20 in dynastic China",
                                },
                                {
                                    cardId: 148,
                ...
                case 3:
                    _a.sent();
                    return [4 /*yield*/, prisma.box.createMany({
                            data: [
                                {
                                    name: "CURRENT"
                                },
...
main()
    .then(function () { return console.log("Registration done successfully!"); })
    .catch(function (e) {
    console.error(e);
    process.exit(1);
})
