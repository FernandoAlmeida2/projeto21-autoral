...
var unauthorized_error_1 = require("../errors/auth-errors/unauthorized-error");
var session_repository_1 = __importDefault(require("../repositories/session-repository"));
function authenticateToken(req, res, next) {
    return __awaiter(this, void 0, void 0, function () {
        var authorization, token, session, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, session_repository_1.default.findByToken(token)];
                case 2:
                    session = _a.sent();
                    if (!session) {
                        res.status(http_status_1.default.UNAUTHORIZED).send((0, unauthorized_error_1.unauthorizedError)());
